...
var e = { data: "" };
var t = (t) => "object" == typeof window ? ((t ? t.querySelector("#_goober") : window._goober) || Object.assign((t || document.head).appendChild(document.createElement("style")), {
	innerHTML: " ",
	id: "_goober"
})).firstChild : t || e;
var l = /(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g;
...
var F = import_react.memo(({ toast: e, position: t, style: o, children: s }) => {
